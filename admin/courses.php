...
?>
<div class="admin-nav">
  <a href="index.php">📊 หน้าหลัก</a><a href="dashboard.php">📈 สรุปผล</a>
  <a href="courses.php" class="active">🏫 หลักสูตร</a><a href="lessons.php">📚 บทเรียน</a>
  <a href="questions.php">📝 ข้อสอบ</a><a href="quiz_admin.php">🧪 ทดลองทำ</a>
